...
run_both_versions: $(BLD_D)main_unoptimized.$(BIN_EXTENSION) $(BLD_D)main_optimized.$(BIN_EXTENSION)
	$(BLD_D)main_optimized.$(BIN_EXTENSION) &
	$(BLD_D)main_unoptimized.$(BIN_EXTENSION) &
